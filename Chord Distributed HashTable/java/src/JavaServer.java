...
public class JavaServer {
  ...
  public static void main(String [] args) {
    try {
      ...
      handler = new FileStoreHandler(ip, Integer.parseInt(args[0]));
  ...
  public static void simple(FileStore.Processor<FileStore.Iface> processor) {
    try {
  ...
  public static void secure(FileStore.Processor<FileStore.Iface> processor) {
    try {
      /*
